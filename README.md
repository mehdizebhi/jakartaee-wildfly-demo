...
Once the runtime starts, you can access the project at [http://localhost:8080/jakartaee-wildfly-demo](http://localhost:8080/jakartaee-wildfly-demo).
...
```
./mvnw clean package
docker build -t jakartaee-wildfly-demo:v1 .
```

You can then run the Docker image by executing:

```
docker run -it --rm -p 8080:8080 jakartaee-wildfly-demo:v1
```
